...
import com.alinesno.infra.base.init.properties.GenConfig;
...
public class GenUtils {
    ...
    public static void initColumnField(GenTableColumn column, GenTable table) {
        ...
        // 设置java字段名
        column.setJavaField(FunctionUtils.toCamelCase(columnName));
        // 设置默认类型
    ...
    public static String getBusinessName(String tableName) {
        ...
        businessName = FunctionUtils.toCamelCase(businessName);
        return businessName;
    }
