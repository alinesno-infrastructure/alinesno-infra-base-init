 ...
 * @version 1.0.0
 */
@TableName("build_gen_table_column")
public class GenTableColumn extends CodeGenBaseEntity {
    ...
    public String getDecimalColumnLength() {
		return decimalColumnLength;
	}
    ...
    public String resolveSearchType() {
        ...
        switch (getQueryType()) {
            case "EQ":
                return RpcWrapper.EQ;
            case "NE":
                return RpcWrapper.NE;
            case "GT":
                return RpcWrapper.GT;
            case "LT":
                return RpcWrapper.LT;
            case "LIKE":
                return RpcWrapper.LIKE;
            default: {
                return RpcWrapper.LIKE;
            }
        }
