...
public class ProjectMenusController extends BaseController<ProjectMenusEntity, ProjectMenusService> {

    @Autowired
    private ProjectMenusService projectMenusService;
    ...
    @Override
    public ProjectMenusService getFeign() {
